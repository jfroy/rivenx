...
- (id)init
{
  ...
  if (oerr != noErr) {
    ...
    @throw [NSException exceptionWithName:@"RXFilesystemException"
                                   reason:@"Riven X was unable to find your logs folder."
  ...
  if (!BZFSDirectoryExists(_logsBase)) {
    ...
    if (!success)
      @throw [NSException exceptionWithName:@"RXFilesystemException"
                                     reason:@"Riven X was unable to create its logs folder in your Logs folder."
                                   userInfo:[NSDictionary dictionaryWithObjectsAndKeys:error, NSUnderlyingErrorKey, nil]];
  }
  ...
  if (fd == -1) {
    ...
    @throw [NSException exceptionWithName:@"RXFilesystemException"
                                   reason:@"Riven X was unable to create a log file."
                                 userInfo:[NSDictionary dictionaryWithObjectsAndKeys:error, NSUnderlyingErrorKey, nil]];
  }
