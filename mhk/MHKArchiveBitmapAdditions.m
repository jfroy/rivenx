...
- (NSDictionary*)bitmapDescriptorWithID:(uint16_t)bitmapID error:(NSError**)error
{
  ...
  NSDictionary* bitmapDescriptor =
      [NSDictionary dictionaryWithObjectsAndKeys:@"tBMP", @"Type", [NSNumber numberWithUnsignedShort:bitmap_header.width], @"Width",
                                                 [NSNumber numberWithUnsignedShort:bitmap_header.height], @"Height", nil];
