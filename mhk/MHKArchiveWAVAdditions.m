...
- (NSDictionary*)soundDescriptorWithID:(uint16_t)soundID error:(NSError**)error
{
  ...
  fprintf(stderr, "sample rate: %u, frames: %u, bit depth: %d, channels: %d, compression: %u\n", data_header.sampling_rate, data_header.frame_count,
          data_header.bit_depth, data_header.channel_count, data_header.compression_type);
  ...
  soundDescriptor = [NSDictionary dictionaryWithObjectsAndKeys:@"tWAV", @"Type", [NSNumber numberWithLongLong:file_offset], @"Samples Absolute Offset",
                                                               ...
                                                               [NSNumber numberWithUnsignedShort:data_header.compression_type], @"Compression Type", nil];
