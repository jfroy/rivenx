...
- (void)performSelector:(SEL)selector inThread:(NSThread*)thread { performSelector(selector, self, nil, thread, NO); }

- (void)performSelector:(SEL)selector inThread:(NSThread*)thread waitUntilDone:(BOOL)wait { performSelector(selector, self, nil, thread, wait); }

- (void)performSelector:(SEL)selector withObject:(id)object inThread:(NSThread*)thread { performSelector(selector, self, object, thread, NO); }
