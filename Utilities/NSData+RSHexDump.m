...
- (NSString *)descriptionFromOffset:(unsigned int)startOffset
{
	return [self descriptionFromOffset:startOffset limitingToByteCount:kDefaultMaxBytesToHexDump];
}

- (NSString *)descriptionFromOffset:(unsigned int)startOffset limitingToByteCount:(unsigned int)maxBytes
{
