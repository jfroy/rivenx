...
- (NSDictionary*)script
{
  ...
  _script = [[NSDictionary alloc] initWithObjectsAndKeys:[NSData dataWithBytes:_program length:s], RXScriptProgramKey,
                                                         [NSNumber numberWithUnsignedShort:_opcode_count], RXScriptOpcodeCountKey, nil];
